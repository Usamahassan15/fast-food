...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Slice & Co — Hot pizza, delivered fast" },
      { name: "description", content: "Order fresh, cheesy pizza, wings, sides and drinks. Delivery or pickup, all across town." },
      { property: "og:title", content: "Slice & Co — Hot pizza, delivered fast" },
      { property: "og:description", content: "Order fresh, cheesy pizza, wings, sides and drinks. Delivery or pickup." },
